...
def assert_performance_criteria(execution_time: float, memory_mb: float, 
                               max_time: float = 0.5, max_memory: float = 300):
    ...
    assert memory_mb < max_memory, f"Memory usage {memory_mb:.1f}MB exceeds {max_memory}MB" 