...
def temp_dirs():
    ...
    yield {"temp_dir": temp_dir, "data_dir": str(data_dir), "poses_dir": str(poses_dir)}
...
class TestBenchmarkParams:
    ...
    def test_benchmark_params_creation(self):
        ...
        params = BenchmarkParams(target_pdb="3test", exclude_pdb_ids=exclude_set)
    ...
    def test_benchmark_params_empty_exclude_set(self):
        ...
        params = BenchmarkParams(target_pdb="test", exclude_pdb_ids=set())
    ...
    def test_benchmark_params_dataclass_properties(self):
        ...
        params = BenchmarkParams(target_pdb="test", exclude_pdb_ids={"exclude"})
...
class TestBenchmarkResult:
    ...
    def test_failed_benchmark_result(self):
        ...
        result = BenchmarkResult(
            success=False, rmsd_values={}, runtime=0.0, error="Processing failed"
        )
    ...
    def test_benchmark_result_to_dict_success(self):
        ...
        result = BenchmarkResult(
            success=True, rmsd_values={"test": 1.5}, runtime=60.0, error=None
        )
    ...
    def test_benchmark_result_to_dict_failure(self):
        ...
        result = BenchmarkResult(
            success=False, rmsd_values={}, runtime=0.0, error="Test error"
        )
...
class TestBenchmarkRunner:
    ...
    def test_benchmark_runner_initialization(self, temp_dirs):
        ...
        try:
            runner = BenchmarkRunner(
                data_dir=temp_dirs["data_dir"], poses_output_dir=temp_dirs["poses_dir"]
            )

            assert runner.data_dir == Path(temp_dirs["data_dir"])
            assert str(runner.poses_output_dir) == temp_dirs[
                "poses_dir"
            ] or runner.poses_output_dir == Path(temp_dirs["poses_dir"])
    ...
    def test_benchmark_runner_with_options(self, temp_dirs):
        ...
        try:
            ...
            assert hasattr(runner, "error_tracker") or not hasattr(
                runner, "enable_error_tracking"
            )
        except ImportError:
            pytest.skip("BenchmarkRunner dependencies not available")
    ...
    def test_benchmark_result_runtime_tracking(self):
        ...
        result = BenchmarkResult(
            success=True, rmsd_values={}, runtime=runtime, error=None
        )
...
class TestBenchmarkRunnerIntegration:
    ...
    def test_runner_error_handling(self, temp_dirs):
        ...
        invalid_params = BenchmarkParams(
            target_pdb="nonexistent", exclude_pdb_ids=set()
        )
...
@pytest.mark.parametrize(
    "n_conformers,template_knn,timeout",
    [
        (50, 20, 300),
        (100, 50, 600),
