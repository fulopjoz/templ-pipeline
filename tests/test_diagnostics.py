...
from templ_pipeline.core.diagnostics import PipelineErrorTracker, ProteinAlignmentTracker
...
class TestProteinAlignmentTracker:
    ...
    def test_track_successful_alignment(self):
        ...
        ProteinAlignmentTracker.track_alignment_attempt("pdb1", "initial", True, details)
    ...
    def test_track_failed_alignment(self):
        ...
        ProteinAlignmentTracker.track_alignment_attempt("pdb1", "initial", False, details)
    ...
    def test_save_alignment_report(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            report_path = ProteinAlignmentTracker.save_alignment_report(temp_dir, "target_pdb")
