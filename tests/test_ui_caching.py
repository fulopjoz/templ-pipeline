...
class TestUICaching:
    ...
    def test_smiles_validation_caching(self):
        ...
        with patch(
            "templ_pipeline.ui.utils.molecular_utils.validate_smiles_input"
        ) as mock_func:
            # Set up the mock to return expected values
            mock_func.return_value = (
                True,
                "Valid molecule (17 atoms)",
                b"mock_binary_data",
            )

            # Import after mocking
            from templ_pipeline.ui.utils.molecular_utils import validate_smiles_input
    ...
    def test_smiles_validation_edge_cases(self):
        ...
        with patch(
            ...
            mock_func.return_value = (
                False,
                "Molecule too small (minimum 3 atoms)",
                None,
            )
    ...
    def test_molecule_image_caching(self):
        ...
        with patch(
            "templ_pipeline.ui.utils.visualization_utils.generate_molecule_image"
        ) as mock_func:
            # Expected image
