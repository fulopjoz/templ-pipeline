...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Time-split example for TEMPL pipeline.")
...
def find_templates_for_test_protein(
    ...
    if not dataset_splits.is_in_split(test_pdb, "test"):
        logger.warning(f"PDB {test_pdb} is not in the test set. Results may not be meaningful.")
