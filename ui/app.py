...
def main():
    ...
    st.markdown("""
    <div style="text-align: center; padding: 2rem 0 1rem 0; background: linear-gradient(90deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 0.5rem; margin-bottom: 2rem;">
    ...
    with st.expander("🔧 Advanced Settings", expanded=False):
        ...
        # Template filtering method selection
        filter_method = st.radio(
            "Filtering Method:",
            ["KNN (Top-K)", "Similarity Threshold"],
            index=0,
            help="Choose how to filter templates: by count (KNN) or by embedding similarity",
