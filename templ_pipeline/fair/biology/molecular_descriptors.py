...
class MolecularDescriptorEngine:
    ...
    def generate_fingerprints(self, smiles: str) -> Optional[ChemicalFingerprints]:
        ...
        try:
            ...
            morgan_fp = self.rdMolDescriptors.GetMorganFingerprintAsBitVect(
                mol, 2, nBits=2048
            )
    ...
    def _calculate_sa_score(self, mol) -> float:
        ...
        try:
            ...
            sa_score = min(
                10.0, ring_complexity + rotatable_complexity + heteroatom_complexity
            )
...
def calculate_template_similarity(
    query_smiles: str, template_smiles: str
) -> Dict[str, float]:
    """
    ...
    try:
        ...
        # Generate fingerprints
        query_morgan = engine.rdMolDescriptors.GetMorganFingerprintAsBitVect(
            query_mol, 2
        )
        template_morgan = engine.rdMolDescriptors.GetMorganFingerprintAsBitVect(
            template_mol, 2
        )
