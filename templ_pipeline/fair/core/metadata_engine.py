...
class MetadataEngine:
    ...
    def create_scientific_metadata(
        self,
        methodology: str = "template_based_pose_prediction",
        ...
        return ScientificMetadata(
            ...
            or ["shape_tanimoto", "color_tanimoto", "combo_score"],
    ...
    def _assess_fair_compliance(
        ...
        return {
            "findable": bool(
                input_metadata.target_identifier and output_metadata.file_hash
            ),
            "accessible": bool(
                output_metadata.primary_output
                and os.path.exists(output_metadata.primary_output)
            ),
            "interoperable": bool(output_metadata.output_format in ["sdf", "pdb"]),
            "reusable": bool(
                scientific_metadata.methodology
                and input_metadata.parameters
                and self.computational_env.dependencies
            ),
        }
    ...
    def _export_yaml(self, record: ProvenanceRecord, output_path: str) -> str:
        ...
        try:
            ...
            with open(yaml_path, "w", encoding="utf-8") as f:
                yaml.dump(
                    metadata_dict, f, default_flow_style=False, allow_unicode=True
                )
...
def generate_quick_metadata(
    ...
    input_meta = engine.create_input_metadata(
        target_identifier=target_id, input_type=input_type, input_value=input_value
    )
