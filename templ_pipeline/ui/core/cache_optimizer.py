...
class CacheOptimizer:
    ...
    def analyze_cache_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            process_pressure = process_memory_mb > (total_memory_mb * 0.15)  # More than 15% of system
    ...
    def optimize_caches_smart(self, force: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            if health.get("process_pressure", False) or health.get("health_score", 0) < 50:
                # Aggressive optimization
                return self._aggressive_optimization(health)
            elif health.get("memory_pressure", False) or health.get("health_score", 0) < 70:
    ...
    def _calculate_health_score(self, memory_percent: float, process_mb: float, session_mb: float) -> int:
