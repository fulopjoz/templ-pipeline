...
class CacheManager:
        ...
        def decorator(func: Callable) -> Callable:
            ...
            def cached_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    logger.info(f"Cache MISS: {func.__name__} took {execution_time:.3f}s")
    ...
    def data_cache(ttl: int = 3600, max_entries: int = 100, 
                   persist: bool = False, show_spinner: bool = False):
        ...
        def decorator(func: Callable) -> Callable:
            ...
            def cached_wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    # Log cache miss
                    logger.debug(f"Data cache MISS: {func.__name__} took {execution_time:.3f}s")
    ...
    def get_performance_report(self) -> str:
        ...
        for func_key, time_saved, func_stats in function_savings[:10]:
            ...
            hit_rate = (
                ...
                if (func_stats['hits'] + func_stats['misses']) > 0 else 0
            )
            report_lines.append(
