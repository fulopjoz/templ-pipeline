...
class ResourceManager:
    ...
    def store_large_object(self, key: str, obj: Any, metadata: Optional[Dict] = None) -> None:
    ...
    def get_resource_report(self) -> Dict[str, Any]:
        ...
        large_objects_size = sum(
            item["size_estimate"] for item in self.large_objects.values()
        ...
        return {
            "memory": {
                ...
                "utilization_percent": (memory_stats["rss_mb"] / self.memory_limit_mb) * 100,
