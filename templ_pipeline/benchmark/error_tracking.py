...
class BenchmarkErrorTracker:
    ...
    def record_target_failure(
        ...
        record = ErrorRecord(
            pdb_id=target_pdb, error_message=error_message, context=context
        )
    ...
    def record_missing_pdb(
        self, pdb_id: str, reason: str, details: str, file_type: str
    ):
        """Records a missing PDB file."""
        context = {"reason": reason, "details": details, "file_type": file_type}
